...
public class XADemo {
    public static void main(String[] args) throws Exception{
        ...
        // 获取账户库的 rm（ap做的事情）
        Connection accountConn = DriverManager.getConnection("jdbc:mysql://211.159.184.140:3306/demo?useUnicode=true&characterEncoding=utf8","root","li19930205");
        ...
        // 获取红包库的RM
        Connection redConn = DriverManager.getConnection("jdbc:mysql://211.159.184.140:3306/demo_1?useUnicode=true&characterEncoding=utf8","root","li19930205");
        ...
        try {
            ...
            // 模拟业务
            String sql = "update demo set userName='123' where id=1";
            ...
            // 模拟业务
            String sql1 =  "update demo set userName='123' where id=1";;
